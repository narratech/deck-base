...
El objetivo de la práctica es realizar un análisis estadístico introductorio sobre un supuesto conjunto de datos telemétrico de *Magic: The Gathering Arena* utilizando **únicamente Python nativo** (estructuras de datos estándar, bucles, condicionales y módulos integrados como `json`).
...
* **`deck-base.ipynb`**: Plantilla del cuaderno interactivo a realizar por el alumno. Contiene la descripción de las características y las celdas donde se deberá escribir el código.
